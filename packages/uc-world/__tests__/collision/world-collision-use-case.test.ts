...
import { WorldCollisionUseCase, CollisionOverlapChecker } from "../../src";
...
describe("@curtain-call/uc-world.WorldCollisionUseCase", () => {
  it("find collision overlapping and notify it", () => {
    ...
    const uc = new WorldCollisionUseCase(overlapChecker);
    uc.checkOverlapAndNotifyToActors(world);
